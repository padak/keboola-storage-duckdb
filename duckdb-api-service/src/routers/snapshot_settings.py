"""Snapshot settings endpoints: hierarchical configuration for snapshots (ADR-004)."""
...
@router.get(
    ...
    description="Get effective snapshot settings for a bucket with inheritance info.",
    dependencies=[Depends(require_project_access)],
)
...
@router.put(
    ...
    description="Set snapshot configuration for a bucket (partial update).",
    dependencies=[Depends(require_project_access)],
)
async def update_bucket_snapshot_settings(
    project_id: str, bucket_name: str, request: SnapshotConfigRequest
) -> SnapshotSettingsResponse:
...
@router.delete(
    ...
    description="Delete local bucket settings (inherit from project).",
    dependencies=[Depends(require_project_access)],
)
async def delete_bucket_snapshot_settings(project_id: str, bucket_name: str) -> None:
...
@router.get(
    ...
    description="Get effective snapshot settings for a table with inheritance info.",
    dependencies=[Depends(require_project_access)],
)
...
@router.put(
    ...
    description="Set snapshot configuration for a table (partial update).",
    dependencies=[Depends(require_project_access)],
)
async def update_table_snapshot_settings(
    project_id: str, bucket_name: str, table_name: str, request: SnapshotConfigRequest
) -> SnapshotSettingsResponse:
...
@router.delete(
    ...
    description="Delete local table settings (inherit from bucket).",
    dependencies=[Depends(require_project_access)],
)
